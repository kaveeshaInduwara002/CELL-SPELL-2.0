...
export default function Workshop1Page() {
  return (
    <PageTransition variant="portal">
      <section className="register-page" id="register-workshop-1">
        <div className="container">
          <div className="register-page__header">
            <Link to="/" className="back-link" id="w1-back-btn">
            ...
            <div className="register-page__title-group">
              ...
              <h1 className="register-page__title">Workshop 01</h1>
          ...
          <div className="register-page__form-wrapper">
            <RegistrationForm
              ...
              eventVenue="University Main Auditorium"
